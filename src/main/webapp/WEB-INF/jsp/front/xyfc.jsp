        ...
        <div class="am-collapse am-topbar-collapse" id="blog-collapse">
            <div style="">
                <ul class="am-nav am-nav-pills am-topbar-nav">
                    ...
                    <li class="am-active"><a href="${pageContext.request.contextPath}/front/xyfc">校园风采</a></li>
...
<div style="width: 100% !important;margin:auto"  class="am-g  ">
    <div class="am-u-md-12 am-u-sm-12">
        <iframe name="front" src="${pageContext.request.contextPath}/洛阳理工学院图册.html" frameborder="0" scrolling="no" style="width: 100%" id="external-frame" ></iframe>
