        ...
        <div class="am-collapse am-topbar-collapse" id="blog-collapse">
            <div style="">
                <ul class="am-nav am-nav-pills am-topbar-nav">
                    ...
                    <li class="am-active"><a target="front" href="${pageContext.request.contextPath}/front/kcxx">课程信息</a></li>
...
<div style="width: 100% !important;margin:auto"  class="am-g  ">
    <div class="am-u-md-12 am-u-sm-12">
        <iframe name="front" src="${pageContext.request.contextPath}/personal/personClass" frameborder="0" scrolling="no" style="width: 100%" id="external-frame" ></iframe>
...
<script>
    ...
    window.onload = function () {
        ...
        setInterval("setIframeHeight(document.getElementById('external-frame'))",800);
    };
