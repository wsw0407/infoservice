...
<div style="width: 400px;margin-left:10px" class="layadmin-user-login-box layadmin-user-login-body layui-form">
    <h1 style="margin-bottom: 10px;margin-left: 70px">分享资源</h1>
    <form class="layui-form" method="POST" id="subForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/resources/add">
        ...
        <div class="layui-form-item" id="content">
            ...
            <div class="layui-input-block">
                <input type="text" name="content"  autocomplete="off" placeholder="请网盘链接或获取具体方式" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="描述资源信息" class="layui-textarea" name="remark"></textarea>
            </div>
        </div>
...
<script>
    ...
    layui.config({
        ...
        form.on('submit(LAY-user-reg-submit)', function(obj){
            ...
            if(user == "" || user == null){
                layer.msg('未登录!',{icon:2,time:1000});
                return false;
            }
