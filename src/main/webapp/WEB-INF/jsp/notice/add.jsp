...
<div style="margin-left:10px" class="layadmin-user-login-box layadmin-user-login-body layui-form">
    <h1 style="margin-bottom: 10px;margin-left: 70px">发布公告</h1>
    <form class="layui-form" method="POST" id="subForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/notice/add">
        <div class="layui-form-item" style="width: 500px;">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="required" lay-reqtext="请填写标题" autocomplete="off" placeholder="请输入标题" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item" style="width: 500px;">
            ...
            <div class="layui-input-inline" style="width: 390px;padding: 0;margin: 0">
                <input type="text" class="layui-input" name="endtime" lay-verify="required" lay-reqtext="请选择结束日期" id="test30" placeholder="yyyy-MM-dd HH:mm">
        ...
        <div class="layui-form-item" id="upfile" style="width: 500px;">
            ...
            <div class="layui-upload-drag"  id="test10">
                ...
                <div class="layui-hide" id="uploadDemoView">
                    <hr>
                    <img src="" alt="上传成功后渲染" id="imagsPlay" style="max-width: 196px">
        ...
        <div class="layui-form-item" style="width: 500px;">
            ...
            <div class="layui-input-block">
                <input type="text" name="link" autocomplete="off" placeholder="请输入连接" class="layui-input">
            </div>
        </div>
            ...
            <div class="layui-input-block">
                <select id="remark" name="remark" style="width: 300px;">
                    <c:forEach items="${status}" var="sta">
                        <option value="${sta.id}" ${sta.id == 2 ? "selected":""} >${sta.status}</option>
                    </c:forEach>
                </select>
            </div>
        ...
        <div style="width:95%;height:600px;margin-left: 40px">
            <textarea name="content" id="edit"  placeholder="请在这里编写公告内容"></textarea>
        </div>
...
<script>
    ...
    layui.config({
        ...
        upload.render({
             elem: '#test10'
            ,url: '${pageContext.request.contextPath}/notice/uploads' //改成您自己的上传接口
            ,auto: false
            //,multiple: true
    ...
    $.get("${pageContext.request.contextPath}/noticetype/listAll",function(data){
        ...
        data.forEach(function(e){
            datas.push({ name:e.typename , value:e.id})
        });
         console.log('datas')
         console.log(datas)
