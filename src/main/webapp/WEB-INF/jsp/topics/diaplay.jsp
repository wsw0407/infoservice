...
<script>
            ...
            ,jump: function(obj, first){
                ...
                if(!first){
                    ...
                    if(content != null && content != ''){
                        location.href ="${pageContext.request.contextPath}/topics/diaplay?page="+obj.curr+"&limit="+obj.limit+"&content="+content
                    }else {
                        location.href="${pageContext.request.contextPath}/topics/diaplay?page="+obj.curr+"&limit="+obj.limit
                    }
    ...
    function querys(content) {
        if(content){
            location.href="${pageContext.request.contextPath}/topics/diaplay?page=1&limit="+'${pageSize}'+"&content="+content
        }else {
            location.href="${pageContext.request.contextPath}/topics/diaplay?page=1&limit="+'${pageSize}'
        }
    }
