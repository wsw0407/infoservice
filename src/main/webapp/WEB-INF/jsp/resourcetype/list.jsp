        ...
        <div class="layui-col-md12" >
            ...
            <div class="layui-card" style="height: 520px;padding-left: 20px;">
                ...
                <div class="x-nav" style="margin-left: 120px;margin-right: 20px">
                    ...
                    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/resourcestype/listpage" title="刷新">
...
<script>
                ...
                checkbox({
                    ...
                    , click: function (node) {
                        ...
                        layer.prompt({
                            ...
                            $.get("${pageContext.request.contextPath}/resourcestype/edit?id="+node.id+"&typename="+value);
                            layer.msg('已修改!',{icon:1,time:1000},function () {
                                  location.href="${pageContext.request.contextPath}/resourcestype/listpage"
                            });
                    ...
                    , del: function (node) {
                        ...
                        $.get("${pageContext.request.contextPath}/resourcestype/delete?id="+node.id);
    ...
    function  addType(){
        layer.prompt({
            ...
            $.get("${pageContext.request.contextPath}/resourcestype/add?typename="+value);
