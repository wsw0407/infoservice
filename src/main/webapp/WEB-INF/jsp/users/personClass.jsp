    ...
    layui.config({
        ...
        var tableIns = table.render({
            ...
            ,cols: [[
                ...
                ,{field:'monday',title:'monday',width:'15%'}
                ,{field:'tuesday',title:'tuesday',width:'15%'}
                ,{field:'wednesday',title:'wednesday',width:'15%'}
                ,{field:'thursday',title:'thursday',width:'15%'}
                ,{field:'friday',title:'friday',width:'15%'}
                ,{field:'saturday',title:'saturday',width:'15%'}
        ...
        var tableIns01 = table.render({
            ...
            ,cols: [[
                ...
                ,{field:'monday',title:'monday',width:'170'}
                ,{field:'tuesday',title:'tuesday',width:'170'}
                ,{field:'wednesday',title:'wednesday',width:'170'}
                ,{field:'thursday',title:'thursday',width:'170'}
                ,{field:'friday',title:'friday',width:'170'}
                ,{field:'saturday',title:'saturday',width:'170'}
