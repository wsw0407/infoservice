            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="resource" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a lay-href="${pageContext.request.contextPath}/resources/displayList">资源列表</a></dd>
                            <dd><a lay-href="${pageContext.request.contextPath}/resources/personResources">我的资源</a></dd>

                            <dd><a lay-href="${pageContext.request.contextPath}/resources/toadd">共享资源</a></dd>
                        </dl>
                    </li>
                    <li data-name="notice" class="layui-nav-item">
                        <a lay-href="${pageContext.request.contextPath}/notice/display" lay-tips="活动公告" lay-direction="2">
                    ...
                    <li data-name="topic" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd>
                                <a lay-href="${pageContext.request.contextPath}/topics/diaplay">查看留言</a>
                            </dd>
                            <dd data-name="workorder">
                                <a lay-href="${pageContext.request.contextPath}/topics/persondiaplay">我的留言</a>
                            </dd>

                        </dl>
                    </li>
                    <li data-name="course_arrange" class="layui-nav-item">
                        <a lay-href="${pageContext.request.contextPath}/personal/personClass" lay-tips=" 教学排课" lay-direction="2">
