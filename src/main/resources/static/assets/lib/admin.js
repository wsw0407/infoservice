            ...
            v: "1.4.0 std", req: l.req, exit: l.exit, escape: function (e) {
                ...
                e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode), n.on("click", function () {
                    ...
                    if (i === e.seconds && !a(this).hasClass(f)) {
                        if (!/^1\d{10}$/.test(n) && !/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/.test(n)) return t.focus(), layer.msg("请输入正确的手机号码（支持澳门台湾）或邮箱");
                        ...
                        $.post('isexist', {phoneOReamail: n}, function (res) {

                            if(res === "true"){
                                if(way === "phone"){
                                    layer.msg("手机号已注册", {icon: 2, shade: 0})
                                }else {
                                    layer.msg("邮箱已注册", {icon: 2, shade: 0})
                                }
                                return;
                            }

                            layer.msg(msg, {icon: 1, shade: 0}), e.elemVercode.focus(), l(), s && s(a)

                            $.post('getCode', {phoneOReamail: n,way:way}, function (data) {
                        ...
                        /* P.req(a.extend(!0, {
                             url: "/athu/code", type: "get", data: {phoneOReamail: n}, success: function (a) {
                                 layer.msg(msg, {icon: 1, shade: 0}), e.elemVercode.focus(), l(), s && s(a)
                             }
                         }, e.ajax))*/
